...
{
    /// <inheritdoc />
    public partial class AddShoppingCartOrderDetailsOrderHeaderDeleteCartItem : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartItemProducts_CartItems_CartItemId",
                        column: x => x.CartItemId,
                        principalTable: "CartItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemProducts_CartItemId",
                table: "CartItemProducts",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemProducts_ProductId",
                table: "CartItemProducts",
                column: "ProductId");
